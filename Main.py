...
#enemy image
enemy_animations = []
enemy_types = ["knight", "warrior", "paladin", "destroyer"]
enemy_health = [75, 100, 150, 300]
...
def show_info():
    ...
    draw_text("Health:" + str(castle.health) + "/" +str(castle.max_health), font, WHITE, SCREEN_WIDTH - 230 , SCREEN_HEIGHT - 25)
    draw_text("1000", font, GREY, SCREEN_WIDTH - 220, 70)
    draw_text(str(TOWER_COST), font, GREY, SCREEN_WIDTH -150, 70)
    draw_text("500", font, GREY, SCREEN_WIDTH - 75, 70)
...
#create crosshair
crosshair = Crosshair(0.050)

#create buttons
repair_button = button.Button(SCREEN_WIDTH - 220, 10, repair_img, 0.09)
tower_button = button.Button(SCREEN_WIDTH - 140, 10, tower_img_100, 0.1)
armor_button = button.Button(SCREEN_WIDTH - 75, 10, armor_img, 0.09)
    ...
    if game_over == False:
        ...
        if level_difficulty < target_difficulty:
            if pygame.time.get_ticks() - last_enemy > ENEMY_TIMER:
                ...
                level_difficulty += enemy_health[0]
        ...
        if next_level == True:
            ...
            if pygame.time.get_ticks() - level_reset_time > 1500:
                ...
                level +=1
                last_enemy = pygame.time.get_ticks()
                target_difficulty *= DIFFICULTY_MULTIPLAYER
                level_difficulty = 0
                enemy_group.empty()
        ...
        draw_text("GAME OVER1", font, GREY, 300, 300)
        draw_text("PRESS  X  TO PLAY AGAIN", font, GREY, 250, 360)
